...
wrap.style.cssText = "width:100%;padding:0";
...
var doms = [];
var tpl = "<a href='{url}' style='display:none; text-decoration: none; color:#000; font-size: 12px; letter-spacing: -1px; font-family: 微软雅黑;' target='_parent'>{txt}</a>";
ajax({
  type: "get",
